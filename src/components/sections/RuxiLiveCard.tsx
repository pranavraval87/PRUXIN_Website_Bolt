...
export function RuxiLiveCard({ industrySlug }: Props) {
  ...
  // Animate bars when idle so widget feels alive
  useEffect(() => {
  ...
  // Animate bars on active call from volume
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="relative">
            ...
            <div className="relative glass-card rounded-2xl border border-white/10 p-8 flex flex-col items-center gap-7">
              {/* Waveform visualiser */}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-semibold text-foreground">
                        {isSpeaking ? "Ruxi is speaking…" : "Listening…"}
                      </span>
